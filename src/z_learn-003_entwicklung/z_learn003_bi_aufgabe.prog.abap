  ...
  CASE save_ok.
    ...
    WHEN 'BEZAHL'.
      ...
      IF betrag IS INITIAL.
        ...
        MESSAGE i011(zlearn077).

      ELSE.
        IF betrag < summe.
          MESSAGE i010(zlearn077).
          CLEAR: betrag, save_ok.
